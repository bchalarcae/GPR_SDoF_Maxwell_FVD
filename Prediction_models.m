...
load('N_MPAA_model.mat');	% Load GPR Prediction model for peak absolute acceleration
load('N_MPMASA_model.mat');	% Load GPR Prediction model for peak mass absolute spectral acceleration
...
[p_npaa,sd_npaa,int_npaa] = predict(MPAA.RegressionGP,input);
[p_npsa,sd_npsa,int_npsa] = predict(MPMASA.RegressionGP,input);
